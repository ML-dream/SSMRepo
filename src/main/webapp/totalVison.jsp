 ...
 function update(){
	...
	$.ajax({
		...
		success:function(text){
           ...
           document.getElementById('machineName5501').value=msg.machineName; 
           document.getElementById('machineIp5501').value=msg.machineIp;   
           document.getElementById('machineSystem5501').value=msg.machineSystem;
           document.getElementById('speedOvr5501').value=msg.speedOvr;
           document.getElementById('driveLoad5501').value=msg.driveLoad;
           document.getElementById('actSpeed5501').value=msg.actSpeed;
           document.getElementById('actFeedRate5501').value=msg.actFeedRate;
           document.getElementById('actSpeedRel5501').value=msg.actSpeedRel;
           document.getElementById('fillText5501').value=msg.fillText;
           document.getElementById('textIndex5501').value=msg.textIndex;
           document.getElementById('progName5501').value=msg.progName;
           document.getElementById('poweronTime5501').value=msg.poweronTime;
           document.getElementById('progStatus5501').value=msg.progStatus;
           document.getElementById('cuttingTime5501').value=msg.cuttingTime;
         	
           document.getElementById('machineName5502').value=msg.machineName; 
           document.getElementById('machineIp5502').value=msg.machineIp;   
           document.getElementById('machineSystem5502').value=msg.machineSystem;
           document.getElementById('speedOvr5502').value=msg.speedOvr;
           document.getElementById('driveLoad5502').value=msg.driveLoad;
           document.getElementById('actSpeed5502').value=msg.actSpeed;
           document.getElementById('actFeedRate5502').value=msg.actFeedRate;
           document.getElementById('actSpeedRel5502').value=msg.actSpeedRel;
           document.getElementById('fillText5502').value=msg.fillText;
           document.getElementById('textIndex5502').value=msg.textIndex;
           document.getElementById('progName5502').value=msg.progName;
           document.getElementById('poweronTime5502').value=msg.poweronTime;
           document.getElementById('progStatus5502').value=msg.progStatus;
           document.getElementById('cuttingTime5502').value=msg.cuttingTime;
           
           document.getElementById('machineName5503').value=msg.machineName; 
           document.getElementById('machineIp5503').value=msg.machineIp;   
           document.getElementById('machineSystem5503').value=msg.machineSystem;
           document.getElementById('speedOvr5503').value=msg.speedOvr;
           document.getElementById('driveLoad5503').value=msg.driveLoad;
           document.getElementById('actSpeed5503').value=msg.actSpeed;
           document.getElementById('actFeedRate5503').value=msg.actFeedRate;
           document.getElementById('actSpeedRel5503').value=msg.actSpeedRel;
           document.getElementById('fillText5503').value=msg.fillText;
           document.getElementById('textIndex5503').value=msg.textIndex;
           document.getElementById('progName5503').value=msg.progName;
           document.getElementById('poweronTime5503').value=msg.poweronTime;
           document.getElementById('progStatus5503').value=msg.progStatus;
           document.getElementById('cuttingTime5503').value=msg.cuttingTime;
           
           document.getElementById('machineName5513').value=msg.machineName; 
           document.getElementById('machineIp5513').value=msg.machineIp;   
           document.getElementById('machineSystem5513').value=msg.machineSystem;
           document.getElementById('speedOvr5513').value=msg.speedOvr;
           document.getElementById('driveLoad5513').value=msg.driveLoad;
           document.getElementById('actSpeed5513').value=msg.actSpeed;
           document.getElementById('actFeedRate5513').value=msg.actFeedRate;
           document.getElementById('actSpeedRel5513').value=msg.actSpeedRel;
           document.getElementById('fillText5513').value=msg.fillText;
           document.getElementById('textIndex5513').value=msg.textIndex;
           document.getElementById('progName5513').value=msg.progName;
           document.getElementById('poweronTime5513').value=msg.poweronTime;
           document.getElementById('progStatus5513').value=msg.progStatus;
           document.getElementById('cuttingTime5513').value=msg.cuttingTime;
