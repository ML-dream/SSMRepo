	...
	<div id= "userdiv" style="margin:0 auto;">
   		...
   		<table >
	         ...
	         <!--    <td style = "width:135px;">
	            ...
	            <td> <input id=button value="绑定" type="button" onclick="bindRfid()" style="width:150px;height:50px"/></td>
	         
	         <td>
	                <label >请将一个标签置于阅读器的探测范围内</label>
	            </td>   
   		...
   		<!-- 表头 -->
   			<tr>
				<!-- <td><label>写入状态</label></td>
	           
	            <td ><input id="Order_id"  name="order_id" class="mini-textbox"  width="240px"enabled="false" allowInput="false "/></td> -->
   				<td><label>客户名称</label></td>  
					<td><input id="partsPlanId" name="partsPlanId" class="mini-textbox" width="200%" required="true" value="${result.partsPlanId}"/></td>
	...
	<script type="text/javascript">
        ...
        function bindRfid(){
        	...
        	$.ajax({
        		...
        		url:"RfidWrite?partsPlanId="+partsPlanId,
        		/* ",
        		data: { data: json }, */
