...
<script src="<%=path %>/resource/timePlanJs/utils.js"></script>
    ...
    <!--style end-->
     <style type="text/css">
	    ...
	    .box-list div{
	    width: 70px;height: 40px;line-height: 40px;text-align: center;
	    float: left;
    ...
    <article>
        <div class="yuyueBox"><!-- 预约内容块开始 -->
            <div class="venue_first">
                <div class="apply">
                    <div id="bookOrder" class="mini-datagrid" style="width:95%;height:200px;" url="<%=path %>/myBookOrderMachine.action"  idField="id" onselectionchanged="onSelectionChanged"  selectOnLoad="true">
                                        ...
                                        <div style="background-color: #efeded; overflow: hidden;"
                                            ...
                                            <script id="dataLine_tmpl" type="text/html">
                                                <ul class="nav nav-tabs"
                                                    style="float: left;">
                                                    {{each content as item i}}
                                                     <li onclick="onSelectDate(this)" id="{{item.machineId}}"  data-machineid="{{item.machineId}}" data-machinename="{{item.date}}">
                                                        <a class="text-center" id="{{item.machineId}}" data-toggle="tab" data-machineid="{{item.machineId}}" href="#"
                                                           aria-expanded="false">
