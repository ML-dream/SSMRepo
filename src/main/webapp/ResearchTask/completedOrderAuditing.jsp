	   ...
	   <!--        <td width="60px" align="right">接收人：</td>
	    ...
	    <!--       <td>订单状态：</td>
	   	...
	   	<!-- 	  <td align="right">客户：</td> -->
	          ...
	          <td><a class="mini-button" onclick="loadgrid()">查询</a><!-- <input value="查找" type="button" onclick="loadgrid()" style="width:50px;"/> --></td>
...
<!-- 	</div> -->
    ...
    <div id="grid1" class="mini-datagrid" style="width:100%;height:85%;"
        ...
        <div field="orderId" width="30" allowSort="true" headerAlign="center" align="center">订单编号
            ...
            <div field="connectorTel" width="20" headerAlign="center" align="center" >联系人电话
            </div>
