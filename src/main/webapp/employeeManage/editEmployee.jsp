    ...
    <!--      	<td><input id="birthday" name="birthday" class="mini-textbox" width="100%"   emptyText="日期格式：2000-01-01"  vtype="date:yyyy-MM-dd" required="true" value="${employee.birthday}" enabled="false"/></td> -->  
       ...
       <tr>
          ...
          <%-- 	<td><label >性别* </label></td>
	        ...
	        <td><input id="mobilePhone"  name="mobilePhone" class="mini-textbox" width="100%" onvalidation="isMobile"  vtype="int" required="true"  value="${employee.mobilePhone}"/></td>
   ...
   <script>
   		...
   		function getForm(leave){
            ...
            if (form.isValid() == false) {
            	...
            	data.connectorTel=mini.get("mobilePhone").getValue();
            	data.staffCode=mini.get("staffCode").getValue();
                var params = eval("("+mini.encode(data)+")");
                var url = 'DoEditEmployeeDetail.action';
